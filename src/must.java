...
int i = 0b101;  //storing 5 in int format in i (PDT does auto assign if not loosing data)
int i = 0x7E;   //stores 50 in int format in i

//--↓ ERROR ↓ --
//(PDT  does auto assign if not narrowing i.e not loosing data) MORE ON THIS LATER BELOW
